...
// order page
    ...
    var addressLine1Input = $("input#addressLine1").val();
    var addressLine2Input = $("input#addressLine2").val();
    var widgetTypeInput = $("#widgetType").val();
    var deliveryDateInput = $("#deliveryDate").val();
    ...
    $(".addressLine1").text(addressLine1Input);
    $(".addressLine2").text(addressLine2Input);
    $(".widgetType").text(widgetTypeInput);
    $(".deliveryDate").text(deliveryDateInput);
...
// how do we display color selection from form?
